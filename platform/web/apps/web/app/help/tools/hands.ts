...
export const HAND_TOOLS: readonly Tool[] = [
  ...
  // the panels rebind to that node (ADR-032).
  {
    ...
    how: [
      ...
      'The pool is asked only when you press for it: you paint what you think the acting seat has, then reveal what the field — and one group of it — actually turned over there, drawn as a difference from your read; at a bet, the pool’s fold rate for the seat facing it cuts your chart for that seat into what continues and what folds, which feeds the blocker table.',
    ],
    steps: [
      ...
      'Paint the range you believe the acting seat arrives with, then press Reveal to see the pool’s beside it.',
    ...
    limits: [
      ...
      'The pool’s range at a spot is the hands that were shown down there — it leans towards hands that reach a showdown, and the badge says what share of the spot it saw. It is the range the seat arrives with, whatever it then did.',
      'Each pool group is asked one after another and a reveal is a few seconds per group; notes and tags need the API, the pool’s ranges need it too.',
    ],
