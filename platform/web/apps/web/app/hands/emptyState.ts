...
const MINE_EMPTY =
  'Nothing is stored yet. Upload the hand histories your poker site exports and they appear here seconds after they land; to read one hand without storing it, paste it instead. If you have uploaded already, the Upload page says when a file had no seat recognised as yours.';
const POOL_EMPTY =
...
function nothingStored(hero: boolean): EmptyStateView {
  if (hero) return { lead: MINE_LEAD, body: MINE_EMPTY, actions: [EMPTY_ACTIONS.upload, EMPTY_ACTIONS.paste] };
