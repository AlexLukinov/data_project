...
<template>
  <section class="space-y-6">
    ...
    <div class="rounded-lg border border-zinc-200 p-4 dark:border-zinc-800">
      <p v-if="status === 'pending'" class="text-sm">Loading…</p>
      <p v-else-if="error" role="alert" class="text-sm text-red-600 dark:text-red-400">Could not load the account: {{ error.message }}</p>
