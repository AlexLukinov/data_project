...
Async, because the application is async and running Alembic through a second sync driver
would mean two Postgres drivers in the dependency set for no benefit.
"""
...
import api.models_hand_notes  # -- registers hand notes and tags on Base.metadata
